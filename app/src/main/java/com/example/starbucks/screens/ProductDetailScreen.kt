...
import com.example.starbucks.ui.theme.Gray500
...
fun ProductDetailScreen(navHostController: NavHostController) {
    Box(
        ...
        Column(
            ...
            ProductHeader(onBackClick = {navHostController.navigateUp()})
...
fun ProductDescription(modifier: Modifier = Modifier) {
    Column(
        ...
        Text(
            text = stringResource(id = R.string.desc), style = TextStyle(
                fontSize = 18.sp,
                color = Gray500,
                fontWeight = FontWeight.W400
            )
...
fun ShowProduct() {
    ...
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .background(LightRed_1, RoundedCornerShape(14.dp)), contentAlignment = Alignment.Center
    ) {
        Column(
            modifier = Modifier
            ...
            Box(modifier = Modifier.background(Color.White, RoundedCornerShape(20.dp))) {
                Row {
                    AppIconComponent(icon = R.drawable.plus, background = DarkGreen , onClick = {
                        counter++
                    })
                    ...
                    Spacer(modifier = Modifier.width(10.dp))
                    AppIconComponent(icon = R.drawable.minus,background = DarkGreen, onClick = {
                        if (counter > 0) {
                            counter--
                        }
                    })
...
@Composable
fun ProductHeader(onBackClick:()->Unit) {
    Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
        AppIconComponent(icon = R.drawable.back, onClick = {
            onBackClick()
        })
